...
Page({
    ...
    onLoad(options) {
        ...
        if (!station) {
            wx.showToast({ title: '站点不存在', icon: 'none' });
            wx.navigateBack();
            return;
        }
        // 加载玩家数据
        ...
        this.setData({
            ...
            specialEventName: (specialEvent === null || specialEvent === void 0 ? void 0 : specialEvent.name) || '',
            specialEventDesc: (specialEvent === null || specialEvent === void 0 ? void 0 : specialEvent.desc) || '',
        });
        this.loadRiders(id);
    },
    async loadRiders(stationId) {
        try {
            ...
            console.warn('[Station] loadRiders failed:', err);
        }
    },
    // ========== 内嵌商店 ==========
    onShopToggle() {
