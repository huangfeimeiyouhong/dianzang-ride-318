...
function shouldReset(lastDate: string): boolean {
 ...
 */
export function checkDailyLoginReward(player: PlayerData): {
  canClaim: boolean;
 ...
 * 领取奖励（将奖励应用到玩家数据）
 */
export function claimDailyReward(player: PlayerData): DailyReward {
...
export function getRewardCycle(): DailyReward[] {
  return REWARD_CYCLE;
}
